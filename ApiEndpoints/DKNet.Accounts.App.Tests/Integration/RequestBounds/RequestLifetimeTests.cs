...
namespace DKNet.Accounts.App.Tests.Integration.RequestBounds;
...
/// <see cref="RequestBoundsConfig" /> wiring on a dknet.accounts <c>TestServer</c> host — the same technique
