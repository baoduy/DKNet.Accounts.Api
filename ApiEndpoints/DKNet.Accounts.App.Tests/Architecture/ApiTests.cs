...
using DKNet.Accounts.App.Tests.Extensions;
...
public class ApiTests
{
    ...
    public void AllApiClassesShouldBeInternal()
    {
        ...
        var types = Types.InAssembly(typeof(DKNet.Accounts.Api.Program).Assembly);

        var result = types
            .That()
            .AreClasses()
            .And().DoNotHaveName(nameof(DKNet.Accounts.Api.Program))
