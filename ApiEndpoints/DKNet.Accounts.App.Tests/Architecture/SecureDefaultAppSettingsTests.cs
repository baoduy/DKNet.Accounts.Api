...
using DKNet.Accounts.Api.Configs.RateLimits;
...
/// environment overlay) so it cannot be masked by <c>DKNet.Accounts.App.TestSupport.TestApiFactoryBase</c> forcing the
...
public class SecureDefaultAppSettingsTests
{
    ...
    private static string AppsettingsPath()
    {
        ...
        return Path.Combine(srcDir, "ApiEndpoints/DKNet.Accounts.Api/appsettings.json");
    }
