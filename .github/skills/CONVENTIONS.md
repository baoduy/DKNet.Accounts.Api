...
```json
{
  ...
  "testPath": "ApiEndpoints/DKNet.Accounts.App.Tests/Skills/DomainModelingSkillTests.cs"
}
```
...
**Fix**: Move to `DKNet.Accounts.Infra/Features/<Feature>/Mappers/` and add `sealed` keyword
