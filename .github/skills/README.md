...
**Reusable AI guidance for building vertical slice features in .NET 10 with ASP.NET DKNet.Accounts APIs, EF Core, and domain-driven design.**
...
- Fast class relationship Q&A with graph + fallback scanning? → [FalkorDB Codegraph Q&A Skill](./falkordb-codegraph/SKILL.md)
...
| **FalkorDB Codegraph Q&A** | 10–25 min | Architecture Discovery | [Read SKILL.md →](./falkordb-codegraph/SKILL.md) |
...
A: 
- **Interface**: `DKNet.Accounts.AppServices/Features/<Feature>/Repositories/IXxxRepository.cs`
- **Implementation**: `DKNet.Accounts.Infra/Features/<Feature>/Repos/XxxRepository.cs` (sealed)
...
AppServices Layer (DKNet.Accounts.AppServices)
...
Domain Layer (DKNet.Accounts.Domains)
  └─ PurchaseOrder entity            (Skill 1: Domain Modeling)

Infra Layer (DKNet.Accounts.Infra)
