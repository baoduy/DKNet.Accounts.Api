...
Source: `DKNet.Accounts.Infra/Features/{EntityFolder}/Mappers/{EntityName}Mapper.cs`
...
> Keep this table updated when running `dotnet ef migrations add <Name> -c CoreDbContext -p DKNet.Accounts.Infra/DKNet.Accounts.Infra.csproj`.
