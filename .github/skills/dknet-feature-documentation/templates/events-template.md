...
Events are dispatched via the DKNet.Accounts message bus with two bus types:
...
See `DKNet.Accounts.Infra/Extensions/ServiceBusSetup.cs` for wiring configuration.
