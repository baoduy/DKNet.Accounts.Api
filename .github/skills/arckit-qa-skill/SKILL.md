...
- Code citations: "See DKNet.Accounts.AppServices/ManualSample/V1/Actions/Create.cs line 45..."
...
2. Evidence: "(1) PurchaseOrder aggregate in DKNet.Accounts.Domains/Features/ManualSample/Entities/PurchaseOrder.cs emits PurchaseOrderCreatedEvent. (2) DKNet.Accounts.AppServices/ManualSample/V1/Events/PurchaseOrderCreatedEventHandler.cs consumes it. See architecture.md §8 (Async Reliability)."
...
3. **Evidence**:
   - Code: `DKNet.Accounts.AppServices/Payouts/V1/Actions/SubmitPayoutHandler.cs` lines 78–92 (retry loop, 3 attempts max).
   - Config: `DKNet.Accounts.Share/Infra/External/PayoutRetryPolicy.cs` (defines RetryCount = 3, DelayMs = 1000).
