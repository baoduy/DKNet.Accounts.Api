...
Use this skill to build high-quality BDD scenarios for `ApiEndpoints/DKNet.Accounts.App.BDDTests/` that are traceable to feature documentation and specifications.
...
- Adding a new `.feature` file under `ApiEndpoints/DKNet.Accounts.App.BDDTests/Features/`.
...
- [ ] Existing hooks/fixtures in `DKNet.Accounts.App.BDDTests/Support/`.
...
|---|---:|---|
| `DKNet.Accounts.App.BDDTests/Features/PurchaseOrders/PurchaseOrder.feature` | 10 | hand-mapped flow, incl. `X-Idempotency-Key` |
| `DKNet.Accounts.App.BDDTests/Features/Products/Product.feature` | 10 | generated flow, no idempotency |
| `DKNet.Accounts.App.BDDTests/Features/Products/ProductList.feature` | 12 | generic list contract (filter/search/orderBy/paging) |
...
Location pattern:
- `ApiEndpoints/DKNet.Accounts.App.BDDTests/Features/<Domain>/<Action>.feature`
...
Location pattern:
- `ApiEndpoints/DKNet.Accounts.App.BDDTests/Features/<Domain>/Steps/<Action>Steps.cs`
...
2. `dotnet test ApiEndpoints/DKNet.Accounts.App.BDDTests`
