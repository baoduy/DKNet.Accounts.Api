...
| Layer | Path |
|-------|------|
| Domain Entity | `DKNet.Accounts.Domains/Features/{EntityFolder}/Entities/{EntityName}.cs` |
| EF Core Mapper | `DKNet.Accounts.Infra/Features/{EntityFolder}/Mappers/{EntityName}Mapper.cs` |
| Create Handler | `DKNet.Accounts.AppServices/{FeatureFolder}/V1/Actions/Create.cs` |
| Update Handler | `DKNet.Accounts.AppServices/{FeatureFolder}/V1/Actions/Update.cs` |
| Delete Handler | `DKNet.Accounts.AppServices/{FeatureFolder}/V1/Actions/Delete.cs` |
| Domain Events | `DKNet.Accounts.AppServices/{FeatureFolder}/V1/Events/` |
| Query Specs | `DKNet.Accounts.AppServices/{FeatureFolder}/V1/Specs/` |
| API Endpoints | `DKNet.Accounts.Api/ApiEndpoints/{EntityName}V1Endpoints.cs` |
