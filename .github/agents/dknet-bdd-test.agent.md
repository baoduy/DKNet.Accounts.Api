...
- `src/ApiEndpoints/DKNet.Accounts.App.BDDTests/Features/**/*.feature`
- `src/ApiEndpoints/DKNet.Accounts.App.BDDTests/Features/**/Steps/*.cs`
- `src/ApiEndpoints/DKNet.Accounts.App.BDDTests/Support/*.cs`
- `src/ApiEndpoints/DKNet.Accounts.App.BDDTests/*.csproj`
...
4. Run validation:
   ...
   - `dotnet test src/ApiEndpoints/DKNet.Accounts.App.BDDTests`
5. Report:
   - changed files
   - scenario count
   - pass/fail results
