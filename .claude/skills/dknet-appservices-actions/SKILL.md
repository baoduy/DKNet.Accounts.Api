...
```
ApiEndpoints/DKNet.Accounts.AppServices/
├── {Feature}/
│   └── V{N}/
...
Create `ApiEndpoints/DKNet.Accounts.AppServices/{Feature}/V1/{Entity}Dto.cs`. Either shape is valid —
...
```csharp
// Hand-written — see DKNet.Accounts.AppServices/ManualSample/V1/PurchaseOrderDto.cs
namespace DKNet.Accounts.AppServices.{Feature}.V1;
...
```csharp
// Generated — see DKNet.Accounts.AppServices/AutomatedSample/V1/ProductDto.cs
...
Create `ApiEndpoints/DKNet.Accounts.AppServices/{Feature}/V1/Actions/Create.cs`, mirroring
`DKNet.Accounts.AppServices/ManualSample/V1/Actions/Create.cs`:

```csharp
using DKNet.EfCore.Specifications.Repositories;
using DKNet.Accounts.Domains.Features.{Feature}.Entities;

namespace DKNet.Accounts.AppServices.{Feature}.V1.Actions;
...
Create `ApiEndpoints/DKNet.Accounts.AppServices/{Feature}/V1/Actions/Update.cs`, mirroring
`DKNet.Accounts.AppServices/ManualSample/V1/Actions/Update.cs`:

```csharp
using DKNet.EfCore.Specifications.Extensions;
using DKNet.EfCore.Specifications.Repositories;
using DKNet.Accounts.AppServices.{Feature}.V1.Specs;
...
Not every action is Create/Update/Delete. `DKNet.Accounts.AppServices/ManualSample/V1/Actions/Cancel.cs`
...
Create `ApiEndpoints/DKNet.Accounts.AppServices/{Feature}/V1/Actions/Delete.cs`, mirroring
`DKNet.Accounts.AppServices/ManualSample/V1/Actions/Delete.cs`:
...
The event record itself lives with the entity in `DKNet.Accounts.Domains` (see `PurchaseOrderCreatedEvent.cs` — a one-line `public sealed record PurchaseOrderCreatedEvent(Guid Id, string CustomerName, decimal Amount);`), raised by `AddEvent(...)` in the constructor. The AppServices layer only owns the **consumer**:

Create `ApiEndpoints/DKNet.Accounts.AppServices/{Feature}/V1/Events/{Entity}CreatedEventHandler.cs`:

```csharp
using Microsoft.Extensions.Logging;
using DKNet.Accounts.Domains.Features.{Feature}.Entities;

namespace DKNet.Accounts.AppServices.{Feature}.V1.Events;
...
Mirror `DKNet.Accounts.AppServices/ManualSample/V1/Events/PurchaseOrderCreatedEventHandler.cs`.
...
Create `ApiEndpoints/DKNet.Accounts.AppServices/{Feature}/V1/Specs/SpecGet{Entity}.cs`, mirroring
`DKNet.Accounts.AppServices/ManualSample/V1/Specs/SpecGetPurchaseOrder.cs`:

```csharp
using DKNet.EfCore.Specifications.Definitions;
using DKNet.Accounts.Domains.Features.{Feature}.Entities;

namespace DKNet.Accounts.AppServices.{Feature}.V1.Specs;
...
`DKNet.Accounts.AppServices/ManualSample/V1/Queries/GetPurchaseOrderById.cs` and `ListPurchaseOrders.cs` for
...
Edit `ApiEndpoints/DKNet.Accounts.AppServices/GlobalUsings.cs`:

```csharp
global using DKNet.Accounts.Domains.Features.{Feature}.Entities;
```
...
`DKNet.Accounts.AppServices.Crud` namespace, inspectable only after a build (not committed to source).
...
- [ ] Namespace follows `DKNet.Accounts.AppServices.{Feature}.V1.Actions`
