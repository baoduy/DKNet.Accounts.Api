...
```
ApiEndpoints/DKNet.Accounts.App.Tests/
...
`ApiFixture` is `WebApplicationFactory<DKNet.Accounts.Api.Program>` + `IAsyncLifetime`.
...
Create `ApiEndpoints/DKNet.Accounts.App.Tests/Integration/{Feature}/V1/{Entity}ActionsIntegrationTests.cs`:

```csharp
using DKNet.EfCore.Specifications;
using DKNet.EfCore.Specifications.Extensions;
using DKNet.Accounts.App.Tests.Integration.Support;
using DKNet.Accounts.AppServices.{Feature}.V1;
using DKNet.Accounts.AppServices.{Feature}.V1.Actions;
using DKNet.Accounts.AppServices.{Feature}.V1.Specs;
using DKNet.Accounts.Domains.Features.{Feature}.Entities;
using SlimMessageBus;

namespace DKNet.Accounts.App.Tests.Integration.{Feature}.V1;
...
| File | Tests |
|---|---:|
| `DKNet.Accounts.App.Tests/Integration/ManualSample/V1/PurchaseOrderActionsIntegrationTests.cs` | 13 |
| `DKNet.Accounts.App.Tests/Integration/ManualSample/V1/PurchaseOrderSecurityTests.cs` | 3 |
| `DKNet.Accounts.App.Tests/Integration/ManualSample/V1/PurchaseOrderListPagingTests.cs` | 3 |
| `DKNet.Accounts.App.Tests/Unit/ManualSample/` (entity, validators, spec, static data) | 16 |
| `DKNet.Accounts.App.Tests/Integration/AutomatedSample/V1/ProductSecurityTests.cs` | 4 |
| `DKNet.Accounts.App.Tests/Integration/AutomatedSample/V1/ProductOwnershipIsolationTests.cs` | 3 |
| `DKNet.Accounts.App.Tests/Unit/AutomatedSample/` (entity, notification handler) | 8 |
...
```bash
cd ApiEndpoints && dotnet ef migrations add <MigrationName> -c CoreDbContext -p DKNet.Accounts.Infra/DKNet.Accounts.Infra.csproj
```
