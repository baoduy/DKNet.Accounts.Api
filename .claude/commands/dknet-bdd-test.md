...
- `ApiEndpoints/DKNet.Accounts.App.BDDTests/Support/*.cs`
- `ApiEndpoints/DKNet.Accounts.App.BDDTests/*.csproj`
...
4. Run validation:
   ...
   - `dotnet test ApiEndpoints/DKNet.Accounts.App.BDDTests`
5. Report:
   - changed files
   - scenario count
   - pass/fail results
