...
3. `ApiEndpoints/DKNet.Accounts.App.BDDTests/Support/BddApiFactory.cs` and `ApiHooks.cs` — fixture wiring you must not duplicate.
...
You may touch only:
- `ApiEndpoints/DKNet.Accounts.App.BDDTests/Features/**/*.feature`
- `ApiEndpoints/DKNet.Accounts.App.BDDTests/Features/**/Steps/*.cs`
- `ApiEndpoints/DKNet.Accounts.App.BDDTests/Support/*.cs` (only when adding shared step infrastructure)
- `ApiEndpoints/DKNet.Accounts.App.BDDTests/DKNet.Accounts.App.BDDTests.csproj` (only when adding a NuGet/project ref through central package management)
...
2. `dotnet test ApiEndpoints/DKNet.Accounts.App.BDDTests/DKNet.Accounts.App.BDDTests.csproj`
